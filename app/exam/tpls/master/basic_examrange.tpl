...
{x2;endif}
				...
				<div class="box itembox" style="padding-top:10px;margin-bottom:0px;">
			        ...
			        <form action="?exam-master-basic-setexamrange" method="post" class="form-horizontal">
						...
						<div class="form-group" style="display: none">
							...
							<div class="col-sm-9">
								<label class="radio-inline">
						          		<input type="radio" class="input-text" name="args[basicexam][model]" value="0"/> 全功能模式（练习和正式考试均开放）
					          	</label>
					          	<label class="radio-inline">
					          		<input type="radio" class="input-text" name="args[basicexam][model]" value="1"/> 练习模式（仅练习功能开放）
					          	</label>
					          	<label class="radio-inline">
					          		<input type="radio" class="input-text" name="args[basicexam][model]" value="2" checked/> 考试模式（仅正式考试开放）
					          	</label>
							</div>
						</div>
						<div class="form-group" style="display: none">
						...
						<div class="form-group">
							<label for="basicexam_self" class="control-label col-sm-3">正式考试试卷：</label>
							<div class="col-sm-9 form-inline">
								<input size="50" class="form-control" type="text" id="basicexam_self" name="args[basicexam][self]" value="{x2;$basic['basicexam']['self']}" /> <a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-master-exams-selectexams&search[subjectid]={x2;$basic['basicsubjectid']}&exams={basicexam_self}&useframe=1&target=basicexam_self&basictype={x2;$basic['basictype']}" valuefrom="basicexam_self">选卷</a>
								<!--<span class="help-block">请在试卷管理处查看试卷ID，将数字ID填写在这里，多个请用英文逗号（,）隔开。留空或填0时将无法进行该项考试。</span>-->
							</div>
						</div>
						<div class="form-group" style="display: none">
						...
						<div class="form-group">
							<label for="basicexam_auto" class="control-label col-sm-3">心肺音考试试卷：</label>
							<div class="col-sm-9 form-inline">
								<input size="50" class="form-control" type="text" id="heart_lung" name="args[basicexam][heart_lung]" value="{x2;$basic['basicexam']['heart_lung']}" /> <a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-master-exams-selectOptExams&organ_type=1&useframe=1&target=heart_lung&basictype={x2;$basic['basictype']}" valuefrom="heart_lung">选卷</a>
								<!--<span class="help-block">请在试卷管理处查看试卷ID，将数字ID填写在这里，多个请用英文逗号（,）隔开。留空或填0时将无法进行该项考试。</span>-->
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-9 form-inline">
								<input size="50" class="form-control" type="text" id="touch" name="args[basicexam][touch]" value="{x2;$basic['basicexam']['touch']}" /> <a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-master-exams-selectOptExams&organ_type=2&useframe=1&target=touch&basictype={x2;$basic['basictype']}" valuefrom="touch">选卷</a>
								<!--<span class="help-block">请在试卷管理处查看试卷ID，将数字ID填写在这里，多个请用英文逗号（,）隔开。留空或填0时将无法进行该项考试。</span>-->
							</div>
						</div>

						<div class="form-group">
							<label for="basicexam_auto" class="control-label col-sm-3">心电图考试试卷：</label>
							<div class="col-sm-9 form-inline">
								<input size="50" class="form-control" type="text" id="cardiogram" name="args[basicexam][cardiogram]" value="{x2;$basic['basicexam']['cardiogram']}" /> <a class="selfmodal btn btn-primary" href="javascript:;" data-target="#modal" url="index.php?exam-master-exams-selectOptExams&organ_type=4&useframe=1&target=cardiogram&basictype={x2;$basic['basictype']}" valuefrom="cardiogram">选卷</a>
								<!--<span class="help-block">请在试卷管理处查看试卷ID，将数字ID填写在这里，多个请用英文逗号（,）隔开。</span>-->
							</div>
						</div>
