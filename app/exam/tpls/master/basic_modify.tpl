		        	...
		        	<form action="index.php?exam-master-basic-modifybasic" method="post" class="form-horizontal">
						<fieldset>
							...
							<div class="form-group" style="display: none">
								...
								<div class="col-sm-9">
									<label class="radio-inline">
										<input name="args[basictype]" type="radio" value="0" disabled {x2;if:!$basic['basictype']}checked{x2;endif}/>正式考试
									</label>
									<label class="radio-inline">
										<input name="args[basictype]" type="radio" value="1" disabled {x2;if:$basic['basictype']}checked{x2;endif}/>单元练习
									</label>
								</div>
							</div>
							<!--<div class="form-group">
