					...
					<h4 class="title" style="padding:10px;">
						...
						<span class="pull-right">
							...
							<ul class="dropdown-menu">
								...
								<li><a href="index.php?{x2;$_app}-master-questions-addOptQuestion&page={x2;$page}{x2;$u}">添加听诊试题</a></li>
								<!--<li><a href="index.php?{x2;$_app}-master-questions-bataddquestion&page={x2;$page}{x2;$u}">批量添加</a></li>-->
								<li><a href="index.php?{x2;$_app}-master-questions-filebataddquestion&page={x2;$page}{x2;$u}">CSV导入理论题</a></li>
							</ul>
						</span>
					</h4>
